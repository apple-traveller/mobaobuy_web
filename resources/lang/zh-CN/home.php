...
return [
    ...
    */
    ...
    'home' => '首页',
    'header_login'=>'请登录',
    'header_register'=>'免费注册',
    'header_working_day'=>'交易时间(工作日)',
    'header_quit'=>'退出',
    'header_curr'=>'当前操作对象',
    'header_personal'=>'个人',
    'header_material_cate'=>'原料分类',
    'header_logo_alt'=>'饲料添加剂供应商-饲料原料价格行情-「秣宝」饲料原料采购网',
    'header_search_placeholder'=>'请输入关键词、类别进行搜索',
    'header_search'=>'搜索',
    'header_find_goods'=>'联系人工找货',
    'header_hot'=>'热门推荐',
    'header_cart'=>'我的购物车',
    'footer_subscription'=>'关注秣宝公众号',
    'footer_applet'=>'关注秣宝小程序',
    'footer_custom_service'=>'沫宝客服',
    'footer_service_1'=>'品类齐全 轻松购物',
    'footer_service_2'=>'便捷交易 订货零风险',
    'footer_service_3'=>'多仓直发 极速配送',
    ...
    'none_quoted'=>'近期上市 敬请期待',//Please look forward to listing in the near future
    'expect'=>'敬请期待',
    'price'=>'价格',
    'num'=>'数量',
    'distance_end'=>'距离结束',
    ...
    'cancel'=>'取消',
    'all'=>'综合',
    'shelf_time'=>'上架时间',//Shelf time
    'highest_price'=>'最高价',//highest price
    'lowest_price'=>'最低价',//lowest price
    'market_price'=>'市场价',
    'store'=>'店铺',
    'prev'=>'上一页',
    'next'=>'下一页',
    'partake'=>'已参与',//Participated
    'sold'=>'已售',
    'rules'=>'活动规则',//Activity rules
    'rules_1'=>'本活动对所有会员开放',
    'rules_2'=>'活动订单需要在30分钟内完成支付，逾期未付款，系统将自动取消订单',
    'rules_3'=>'如有任何疑问，请联系在线客服或拨打免费服务热线',
    'no_login_msg'=>'请先登录再进行操作',//Please login before you operate
    'no_real_name_msg'=>'请先实名再进行操作',//Real name before operation, please
    'login'=>'先登录',//
    'go_real_name'=>'去实名',//
    'see_others'=>'再看看',//
    'remark'=>'备注',
    'error_tips_info'=>'信息有误，请重试！',
    'error_tips_num'=>'数量有误，请重新输入！',
    'required_tips_num'=>'请输入数量！',
    'required_tips_price'=>'请输入价格！',
    'required_tips_delivery_area'=>'请输入交货地！',
    'stock'=>'库存',
    'rush_buy'=>'立即抢购',//Rush to buy
    'start_time'=>'开始时间',
    'end_time'=>'结束时间',
    'query'=>'查询',
    'by_day'=>'按日',
    ...
    'member_login'=>'会员登录',//Member login
    'sms_login'=>'短信登录',//SMS login
    'third_login'=>'第三方账号登录',//Third party account login
    'wx_login'=>'微信登录',//WeChat login
    'forget_password'=>'忘记密码',//Forget password
    'login_account'=>'请输入您的账户名',//Please enter your account name.
    'login_password'=>'请输入您的密码',//Please enter your password.
    'login_mobile'=>'请输入您的手机号',//Please enter your mobile phone number.
    'login_code'=>'请输入您的短信验证码',//Please enter your SMS Verification Code
    'code_required_tips'=>'验证码不能为空',//
    'code_error_tips'=>'您输入的验证码错误',//
    'register'=>'注册新账号',//Register a new account
    'get_code'=>'获取验证码',
    'regain'=>'重新获取',
    'login_prefix'=>'已有账号，可',//Existing account,
    'login_suffix'=>'直接登录',//can be directly logged in
    'mobile'=>'手机号',
    'account_name'=>'用户名',
    'graphic_code'=>'图形验证码',
    'code'=>'手机验证码',
    'change_code'=>'点击换一个校验码',//Click to change a check code
    'new_password'=>'新密码',//New password
    'password_placeholder'=>'密码由8-16个字符(字母+数字组成)',//Password consists of 8-16 characters (letters + numbers)
    'edit_success'=>'修改成功',
    ...
    'home_welcome'=>'尊敬的用户，欢迎来到秣宝网!',
    'home_dynamic'=>'成交动态',
    'home_service'=>'一站式服务',//One-stop service
    'home_logistics'=>'物流',
    'home_finance'=>'金融',
    'home_quotation'=>'行情',
    'home_cloud_quotient'=>'云商',
    'home_intelligence'=>'智能',
    'home_logistics_alt'=>'饲料物流服务',
    'home_finance_alt'=>'饲料产业链金融',
    'home_quotation_alt'=>'饲料行情和饲料资讯',
    'home_cloud_quotient_alt'=>'饲料电商平台',
    'home_intelligence_alt'=>'饲料智能产业',
    'home_logistics_by'=>'运输、仓储、加工一体服务',
    'home_finance_by'=>'解决产业链上下游资金问题',
    'home_quotation_by'=>'维生素最及时的行情和资讯',
    'home_cloud_quotient_by'=>'用更少的人 接更多的单',
    'home_intelligence_by'=>'助力智慧维生素产业升级',
    'home_supplier'=>'供应商',//Supplier
    'home_cooperative'=>'合作品牌',//Cooperative brand
    'home_friendship'=>'友情链接',//Friendship link

    #报价列表
    'quote_list_tips'=>'暂无最新报价数据。如需订购，请点击联系人工找货',

    #集采火拼
    'wholesale'=>'集采火拼',
    'target'=>'目标',
    'exceed'=>'单价不超过',//Price not exceeding

    #限时秒杀
    'buy_limit'=>'限时抢购',//flash sale
    'price_spike'=>'秒杀价',//Price spike
    'cumulative_sale'=>'累计售出',//Cumulative sale

    #寄售清仓
    'consign'=>'寄售清仓',//consign

    #求购列表
    'inquiry'=>'求购',
    'release_time'=>'发布时间',//Release time
    'intentional_price'=>'意向价格',//Intentional price
    'trader'=>'跟进交易员',
    'sendMsg'=>'点击这里给我发消息',//Click here to send me a message
    'negotiating'=>'正在洽谈',//Negotiating
    'supply_commodity'=>'我要供货',//Supply commodity
    'none_inquiry'=>'暂无求购信息',//No purchase information yet
    'inquiry_find_goods'=>'写下您的真实需求，包括品种、厂商、规格等，收到后我们会立即给您回电确认，我们会尽快帮您找货',//Write down your real needs, including varieties, manufacturers, specifications, etc. We will call you back immediately after receiving confirmation, we will help you find goods as soon as possible.
    'post_now'=>'立即发布',//Post Now
    'content_alert_msg'=>'请填写您的内容',//Please fill in your content.
    'content_success_msg'=>'恭喜发布成功，客服人员会在第一时间与您电话联系，请保持手机畅通',//Congratulations on the successful release. Customer service personnel will contact you by telephone at the first time. Please keep your mobile phone open.
    'inquiry_quote'=>'我要报价',//
    'inquiry_quote_tips'=>'请在下方填写您的真实报价（价格必填），并对您的货物描述清楚。',//Please fill in your true quotation (price required) below and describe your goods clearly.
    'inquiry_quote_warning'=>'不合理报价会被系统自动屏蔽',
    'inquiry_quote_success'=>'提交报价成功！',
    ...
    'recruit_type'=>'职位类别',
    'recruit_branch'=>'部门名称',
    'none_recruit_tips'=>'暂无招聘信息',//No recruitment information yet
    'release'=>'发布',
    'recruit_pay'=>'职位薪资',
    'working_experience'=>'经验',
    'education'=>'学历',
    'job_desc'=>'岗位说明',
    'recruit_return_list'=>'返回职位列表',
    'recruit_apply'=>'申请职位',
    'upload_resume'=>'上传简历',//Upload resume
    ...
    'historical_quotation'=>'历史报价',//Historical quotation
