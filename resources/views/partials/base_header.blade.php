<link rel="shortcut icon" href="{{getFileUrl(getConfig('shop_ico', asset('img/favicon.ico')))}}" type="image/x-icon">
<link href="{{asset('css/font_859393_k63z0kfqy8.css')}}" rel="stylesheet">
