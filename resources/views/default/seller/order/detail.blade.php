                            ...
                            <div class="step_info">
                                <div class="order_operation order_operation100">
                                    <div class="item">
                                        ...
                                        <div class="value">
                                            <div class="bf100 fl"><textarea name="to_buyer" class="textarea"></textarea></div>
                                            <div class="order_operation_btn">
                                                <input name="confirm" type="button" value="确认" onclick="conf({{ $orderInfo['id'] }})" class="btn btn25 red_btn">
                                                <input name="cancel" type="button" value="作废" onclick="cancelOne({{ $orderInfo['id'] }})" class="btn btn25 red_btn">
