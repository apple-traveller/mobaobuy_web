        ...
        <div class="content">
            ...
            <div class="flexilist mt30">
                <div class="common-content">
                    <form name="theForm" action="/seller/order/saveFree" method="post">
                        ...
                        <div class="goods_btn">
                            ...
                            <input type="button" value="取消" class="btn btn35 btn_blue" onclick="location.href='/seller/order/detail?id={{$id}}&currentPage={{$currentPage}}'">
                        </div>
                    </form>
