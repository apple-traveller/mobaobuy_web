...
@section('body')
    <div class="warpper">
        <div class="title">委托寄售活动</div>
        <div class="content">
            <div class="flexilist">
                <div class="common-head">
                    <div class="fl">
                        <a href="/seller/activity/consign/add"><div class="fbutton"><div class="add" title="添加寄售"><span><i class="icon icon-plus"></i>添加寄售</span></div></div></a>
                    </div>
                    <div class="refresh">
