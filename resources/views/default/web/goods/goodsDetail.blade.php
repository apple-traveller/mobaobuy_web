...
//                        res += '<br/>  开盘 : ' + params[0].value[0] + '  最高 : ' + params[0].value[3];
                        res += '<br/>  最低价 : ' + params[0].value[0] + '  最高价 : ' + params[0].value[1];
                        return res;
                    }
                },
                legend: {
	...
	<div class="w1200 pr ovh">
        ...
        <div class="w1200" style="margin-top: 80px;">
            <div class="History_offo">
                <ul class="">
                    <li style="margin-left:25px;text-align:center;"><h2>商家推荐</h2></li>
                </ul>
            </div>
         <div>
        <ul class="quoteList">
            ...
            @foreach($quoteList as $vo)
                <li>
                    ...
                    <span style="width:25%;"><a href="/goodsDetail/{{$vo['id']}}/{{$vo['shop_id']}}">{{$vo['goods_name']}}</a></span>
        ...
        <div class="w1200" style="margin-top: 80px;">
            <div class="History_offo">
                <ul class="HistoryLi">
                    <li style="margin-left:25px;text-align:center;" class="titlecurr"><h2>历史报价</h2></li>
                    <li style="text-align: center;"><h2>商品详情</h2></li>
                </ul>
            </div>
        <div>
