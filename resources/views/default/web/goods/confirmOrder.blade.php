...
<div class="w1200">
	...
	<div class="address whitebg ovh mt20">
		...
		<div class="address_line">
			...
			<div class="fr">
				<div class="ovh"><span class="fl gray">小计:</span><span class="ordprice fl tar orange total_price">{{amount_format($goods_amount)}}</span></div>
				<div class="mt10 ovh mr30"><span class="fl gray">运费:</span><span class="ordprice fl tar orange">待商家确认</span></div>
				<div class="mt10 ovh"><span class="fl gray lh40">总计:</span><span class="ordprice fl tar orange fs22 total_price">{{amount_format($goods_amount)}}</span></div>
			</div>
		</div>
