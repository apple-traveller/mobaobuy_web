...
@section('content')
	<div class="clearfix" style="background-color:white;">
		<div class="w1200 pr ovh">
			<div class="crumbs mt5">{{trans('home.curr')}}： <a href="javascript:">{{trans('home.consign')}}</a> &gt;<a href="javascript:">{{trans('home.product_details')}}</a><span class="gray"></span></div>
			...
			<div class="fl ml35 mt5">
				...
				<div class="Time_limit mt3">
					<span class="xs_ms fl">{{trans('home.consign')}}</span>
				</div>
				<style type="text/css">
				...
				{{--<div class="pro_detail">--}}
                    ...
                    {{--<span  class="ml35 fl">{{$goodsInfo['packing_spec'].$goodsInfo['unit_name'].'/'.getLangData($goodsInfo,'packing_unit')}}</span>--}}
				{{--</div>--}}
                {{--<div class="pro_detail">--}}
                ...
                {{--</div>--}}
                {{--<div class="pro_detail">--}}
                    {{--<span class="ml15 letter-space fl" style="letter-spacing: 1px;width:88px">{{trans('home.mfg_date')}}</span>--}}
                ...
                <table class="detail_table mt10 ">
                    ...
                    <tr>
                        ...
                        <td>@if($goodsInfo['activity_num']>0) {{$goodsInfo['activity_num']}} @else 0 @endif{{$goodsInfo['unit_name']}}</td>
                    ...
                    <tr>
                        ...
                        <td>{{$goodsInfo['production_date']}}</td>
                    </tr>
                    </tbody>
                </table>
