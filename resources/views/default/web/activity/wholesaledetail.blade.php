			...
			<div class="fl ml35 mt5">
				...
				<div class="pro_detail">
                    ...
                    <div class="pur_volume ml15">
                        <span class="pur bbright shop_num_reduce" pid="{{$goodsInfo['packing_spec']}}" canSell="{{$goodsInfo['activity_num'] - $goodsInfo['partake_quantity']}}">-</span>
                        ...
                        <span id="min_limit" min-limit="{{$goodsInfo['min_limit']}}" class="pur bbleft shop_num_plus" pid="{{$goodsInfo['packing_spec']}}" canSell="{{$goodsInfo['partake_quantity']}}">+</span>
                    </div>
