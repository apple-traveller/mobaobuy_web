    ...
    <div class="top-search-div">
        <div class="search-div">
            ...
            <div class="search-box">
                ...
                <a class="contact_artificial tac br1 db fl ml10" href="javascript:" onclick="javascript:window.open('http://wpa.qq.com/msgrd?v=3&uin={{getConfig('service_qq')}}&site=qq&menu=yes');">联系人工找货</a>
                {{--<a rel="nofollow" ></a>--}}
