        ...
        <div class="w1200">
            <div class="member_left">
                ...
                <div class="member_list_mode">
                    ...
                    <ul class="member_left_list">
                        <li @if(request()->path() == '') class="curr" @endif><a href="/">用户信息</a></li>
                        <li @if(request()->path() == 'updateUserInfo') class="curr" @endif><a href="/updateUserInfo">实名认证</a></li>
                        <li @if(request()->path() == 'forgotPwd') class="curr" @endif><a href="/forgotPwd">修改密码</a></li>
                        <li @if(request()->path() == 'paypwd') class="curr" @endif><a href="/paypwd">支付密码</a></li>
