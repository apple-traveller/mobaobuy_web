	...
	<div class="w1200 pr">
		<div class="crumbs mt5 mb5"><span class="fl">当前位置：</span><a class="fl" href="/">产品列表</a>
            <div class="condition">
                ...
                <div style="margin-left:20px;display: none;" class="mode_add tac ml10 condition_tag" id="cate_tag" cate_id=""><i style="cursor: pointer" class="mode_close close_cate"></i></div>
            </div>
			<div class="pro_Open pro_Open_up"></div>
			<div class="fr">共<font class="orange">{{$search_data['total']}}</font>个相关产品</div></div>
		...
		<div class="pro_screen">
			...
			<div class="pro_brand" style="border-bottom: none;">
				<dl class="fl filter_item"><dt class="fl">地区:</dt>
					...
					<div onclick="getInfo(1)"  class="fl pro_brand_btn region_btn ml20">确定</div><div class="fl pro_brand_btn region_btn ml20">取消</div>
				</dl>
			</div>
            @endif
		</div>
