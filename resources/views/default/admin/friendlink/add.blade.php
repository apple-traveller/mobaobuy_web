                ...
                <form action="/admin/link/save" method="post" name="theForm" enctype="multipart/form-data" id="link_form" novalidate="novalidate">
                    <div class="switch_info user_basic">
                        ...
                        <div class="item">
                            ...
                            <div class="label_value">
                                <input name="link_name_en" value="" class="text" autocomplete="off" type="text">
                                <div class="form_prompt"></div>
                            </div>
                        </div>
                        <div class="item">
                        ...
                        <div style="margin-top: 10px;" class="item shop_logo">
                            ...
                            <div class="label_value">
                                <div class="type-file-box" style="width:600px;">
                                    ...
                                    <img  style="width:60px;height:60px;margin-left:10px;margin-top:-10px;display:none;"   class="layui-upload-img" id="demo1" >
