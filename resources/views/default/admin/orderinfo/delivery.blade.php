...
@section('iframe')
    ...
    <div class="warpper">
        <div class="title"><a href="/admin/orderinfo/detail?id={{$id}}&currpage={{$currpage}}" class="s-back">返回</a>发货单 - 添加发货单</div>
        <div class="content">

            <div class="flexilist">
                <div class="mian-info">
                    <form action="/admin/orderinfo/saveDelivery" method="post" enctype="multipart/form-data" name="theForm" id="article_form" novalidate="novalidate">
                                    ...
                                    <div class="list-div" id="listDiv">
                                        ...
                                        <table class="layui-table" lay-data="{ url:'/admin/orderinfo/GoodsForm', page:false, id:'idTest',method:'post',where:{'order_id':'{{$id}}'}}" lay-filter="test">
                                            ...
                                            <tr>
                                                ...
                                                <th lay-data="{field:'goods_sn'}">产品编码</th>
