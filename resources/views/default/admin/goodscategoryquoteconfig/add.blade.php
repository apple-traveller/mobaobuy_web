...
@section('iframe')
    ...
    <div class="warpper">
        <div class="title"><a href="/admin/goodscategoryquoteconfig/list" class="s-back">返回</a>商品分类 - 添加配置</div>
        <div class="content">
                    ...
                    <form action="/admin/goodscategoryquoteconfig/save" method="post" enctype="multipart/form-data" name="theForm" id="article_form" novalidate="novalidate">
                        <div class="switch_info" style="display: block;">
                            ...
                            <div class="item">
                                ...
                                <div class="label_value">
                                    <input type="number" name="max" class="text" value="" maxlength="40" autocomplete="off" id="max">
                            ...
                            <div class="item">
                                ...
                                <div class="label_value">
                                    <input type="number" name="min" class="text" value="" maxlength="40" autocomplete="off" id="min">
                                    <div class="form_prompt"></div>
                                    <div class="notic"></div>
                                </div>
                            </div>
