                    ...
                    <form action="/admin/activity/consign/save" method="post" enctype="multipart/form-data" name="theForm" id="consign_form" novalidate="novalidate">
                        <div class="switch_info" style="display: block;">
                            ...
                            <div class="item">
                                ...
                                <input type="hidden" name="place_id" id="place_id" value="{{ $consign_info['place_id'] }}"/>
                                <input type="text" name="place_id_LABELS" old="" autocomplete="off" treeId="" value="{{ $consign_info['delivery_place'] }}" id="delivery_place" treeDataUrl="/admin/region/getRegionTree" size="40"  class="text" title="">
