...
@section('iframe')
    ...
    <div class="warpper">
        <div class="title"><a href="/admin/seckill/time/list?currpage={{$currpage}}" class="s-back">返回</a>秒杀 - 编辑秒杀活动时间段</div>
        <div class="content">
                        ...
                        <div class="switch_info" style="display: block;">
                            ...
                            <div class="item">
                                ...
                                <div class="label_value">
                                    <input type="text" name="title" class="text" value="{{$time['title']}}" maxlength="40" autocomplete="off" id="title">
                            ...
                            <div class="item">
                                ...
                                <div class="label_value">
                                    <input type="text" name="begin_time" class="text" value="{{$time['begin_time']}}" maxlength="40" autocomplete="off" id="begin_time">
                                    <div class="form_prompt"></div>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                ...
                                <div class="label_value">
                                    <input type="text" name="end_time" class="text" value="{{$time['end_time']}}" maxlength="40" autocomplete="off" id="end_time">
                                    <div class="form_prompt"></div>
                                </div>
                            </div>
