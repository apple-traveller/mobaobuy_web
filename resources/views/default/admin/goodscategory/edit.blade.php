                            ...
                            <div class="switch_info">
                                <div class="item">
                                    ...
                                    <div class="label_value">
                                        <input type="text" name="cat_name" class="text" id="cat_name" maxlength="100" value="{{$cate['cat_name']}}">
                                ...
                                <div class="item">
                                    ...
                                    <div class="label_value">
                                        <input type="text" name="cat_name_en" class="text" id="cat_name_en" maxlength="100" value="{{$cate['cat_name_en']}}">
                                        <div class="form_prompt"></div>
                                    </div>
                                </div>
                                <div class="item">
                                    ...
                                    <div class="label_value">
                                        <input type="text" name="cat_alias_name" class="text" id="cat_alias_name" maxlength="100" value="{{$cate['cat_alias_name']}}">
                                        <div class="form_prompt"></div>
                                    </div>
                                </div>
                                    ...
                                    <div class="label_value">
                                        <div class="checkbox_items">
                                            <div class="checkbox_item">
                                                <input type="radio" class="ui-radio" @if($cate['is_show']==1) checked @endif name="is_show" id="is_show_1" value="1" >
                                                <label for="is_show_1" class="ui-radio-label">是</label>
                                            </div>
                                            <div class="checkbox_item">
                                                <input type="radio" class="ui-radio" @if($cate['is_show']==0) checked @endif name="is_show" id="is_show_0" value="0">
                                ...
                                <div class="item">
                                    ...
                                    <div class="label_value">
                                        <div class="checkbox_items">
                                            <div class="checkbox_item">
                                                <input type="radio" class="ui-radio" @if($cate['is_nav_show']==1) checked @endif name="is_nav_show" id="show_in_nav_1" value="1">
                                                <label for="show_in_nav_1" class="ui-radio-label">是</label>
                                            </div>
                                            <div class="checkbox_item">
                                                <input type="radio" class="ui-radio" @if($cate['is_nav_show']==0) checked @endif name="is_nav_show" id="show_in_nav_0" value="0" >
                                ...
                                <div class="item">
                                    ...
                                    <div class="label_value">
                                        <div class="checkbox_items">
                                            <div class="checkbox_item">
                                                <input type="radio" class="ui-radio" @if($cate['is_top_show']==1) checked @endif name="is_top_show" id="is_top_style_1" value="1">
                                                <label for="is_top_style_1" class="ui-radio-label">是</label>
                                            </div>
                                            <div class="checkbox_item">
                                                <input type="radio" class="ui-radio" @if($cate['is_top_show']==0) checked @endif name="is_top_show" id="is_top_style_0" value="0">
                                ...
                                {{--<div class="item">--}}
                                    ...
                                    {{--<div class="label_value">--}}
                                        {{--<input type="text" name="category_links" class="text" id="category_links" maxlength="20" value="{{$cate['category_links']}}" size="27">--}}
                                        {{--<div class="form_prompt"></div>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
