                    ...
                    <form action="/admin/ad/save" method="post" enctype="multipart/form-data" name="theForm" id="article_form" novalidate="novalidate">
                        <div class="switch_info" style="display: block;">
                            ...
                            <div class="item">
                                ...
                                <div class="label_value">
                                    <input type="text" name="ad_name" class="text" value="" maxlength="40" autocomplete="off" id="ad_name">
                                    <div class="form_prompt"></div>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                ...
                                <div class="label_value">
                                    <input type="text" name="start_time" class="text"maxlength="40" autocomplete="off" id="start_time">
                                    <div class="form_prompt"></div>
                                    <div class="notic"></div>
                                </div>
                            </div>
