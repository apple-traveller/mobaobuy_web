...
(1, 5, 'P000001', '蛋鸡维生素', 4, '优利保', 1, 'KG', '', '10', '桶', ';1:1;', '含量:100%', 'PC详情', '移动端详情','1500', now(), now()),
(2, 6, 'P000002', '饲料级维生素A', 1, '新和成', 1, 'KG', '', '25', '箱', ';1:2;', '含量:50万 IU/g', 'PC详情', '移动端详情','800', now(), now()),
(3, 7, 'P000003', '饲料级维生素B1', 5, '天新', 1, 'KG', '', '25', '箱', ';1:6;', '含量:99%', 'PC详情', '移动端详情','600', now(), now()),
(4, 8, 'P000001', '饲料级维生素C', 3, '天力兴农', 1, 'KG', '', '25', '桶', ';1:1;', '含量:100%', 'PC详情', '移动端详情','1500', now(), now());
