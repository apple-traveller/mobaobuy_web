...
class WeiXin
{
    ...
    ///微信开发平台登录
    const OPEN_PREFIX = 'https://open.weixin.qq.com/connect';
    const OPEN_QRCONNECT_URL = '/qrconnect?';
...
<Nonce><![CDATA[%s]]></Nonce>
     ...
     * @return string
     */
    public function getOpenOauthRedirect($callback,$state='',$scope='snsapi_login'){
        return self::OPEN_PREFIX.self::OPEN_QRCONNECT_URL.'appid='.$this->appid.'&redirect_uri='.urlencode($callback).'&response_type=code&scope='.$scope.'&state='.$state.'#wechat_redirect';
    }
