...
use App\Repositories\ActivityConsignRepo;
use App\Repositories\GoodsRepo;
use App\Repositories\UserCollectGoodsRepo;
use Carbon\Carbon;

class ActivityConsignService
{
    use CommonService;
    ...
    {
        return ActivityConsignRepo::getListBySearch($pager, $where);
    }
    ...
    {
        $res = ActivityConsignRepo::getInfo($id);
    ...
    public static function create($data)
    {
        ...
        return ActivityConsignRepo::create($data);
    }
    ...
    {
        return ActivityConsignRepo::modify($id, $data);
    }
    ...
    {
        return ActivityConsignRepo::delete($id);
    }
    ...
    public static function getList($params = [], $page = 1, $pageSize = 10)
    {
        ...
        $info_list = ActivityConsignRepo::getListBySearch(['pageSize' => $pageSize, 'page' => $page, 'orderType' => ['end_time' => 'desc']], $condition);
    ...
    {
        $info_list = ActivityConsignRepo::getList(['end_time'=>'desc'], $condition);
...
//        return $buyLimitArr;
    ...
    {
        $id = decrypt($id);
        return ActivityConsignRepo::addClickCount($id);
    }

    public static function detail($id,$userId)
    {
        $id = decrypt($id);
        $ActivityInfo =  ActivityConsignRepo::getInfo($id);
...
//        }
    ...
    public static function getActivityWholesaleById($id){
        $id = decrypt($id);
        $activityPromoteInfo = ActivityConsignRepo::getInfo($id);
